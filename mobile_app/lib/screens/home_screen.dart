                  ...
                  return Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 16),
                        const Text('No books found.', style: TextStyle(color: Colors.grey, fontSize: 18)),
                        const SizedBox(height: 8),
                        TextButton(
                          onPressed: () => ref.invalidate(booksProvider),
                          child: const Text('Try Again', style: TextStyle(color: Color(0xFF003399))),
                        ),
                      ],
                    ),
                  );
              ...
              loading: () => const Center(
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 16),
                    Text('Loading textbooks...', style: TextStyle(color: Colors.grey)),
                  ],
                ),
              ),
